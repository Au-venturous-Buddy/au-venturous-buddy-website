          ...
          <ResponsiveHeader level={1} maxSize={2} minScreenSize={800}>
            ...
            >
              <div style={{ margin: 0 }} className="kali-profile-image">
                <StaticImage src="../images/InfinitelyAuventurousProfile.png" alt="Infinitely Auventurous Profile Picture" layout="fullWidth"></StaticImage>
              </div>
            </div>
          ...
          <div style={{textAlign: `center`, margin: 0}}>
            ...
            >
              <div style={{ margin: 0 }} className="hero-image">
                <StaticImage src="../images/InfinitelyAuventurous.png" alt="Infinitely Auventurous" layout="fullWidth"></StaticImage>
              </div>
            </div>
            </ResponsiveHeader>
          </div>
